...
# languages express the filter (F1-F5) the kunai and pcap-filter
# (cbpfc) bars are paired and colored.
#
# Run from this publication's directory:
...
# filter cell -> its own-stream accept_all baseline
ACCEPT = {
...
def main():
    ...
    ap.add_argument("-o", "--out",
                    default=str(Path(__file__).resolve().parents[1] /
                                "paper/figures/fig_datapath.pdf"))
    args = ap.parse_args()
    ...
    # The supplied camera-ready PDF embeds TrueType fonts.
