...
\fill[red!35] (6.42,0.05) rectangle ++(0.32,0.22);
\draw (6.42,0.05) rectangle ++(0.32,0.22);
...
\draw[slot, -{Stealth[length=1.8mm]}] (3.4,-0.7) -- (stack.north);

% --- example bounds-checked access ---
\node[font=\footnotesize, align=left, anchor=west] (acc) at (0,-3.25)
  {\texttt{where inner.dst == ...}\;$\Rightarrow$\\
   \quad\texttt{load32(data + layer\_start[ipv4@inner] + 16)}\\
   \quad after check \texttt{ptr + 4 $\le$ data\_end}};
\draw[arr, red!60!black] (5.7,-2.95) .. controls (7.2,-1.9) and (7.0,-0.6) .. (6.6,0.0);
