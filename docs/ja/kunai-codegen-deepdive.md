...
連載をお読みいただきありがとうございました。kunai は [bpf-ninja](https://github.com/takehaya/bpf-ninja) の default filter syntax として実 packet capture に使えるので、ぜひ試してみてください。vocab 追加 (1 ファイル) も歓迎します。
