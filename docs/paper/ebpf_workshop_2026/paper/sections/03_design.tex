...
project repository.\footnote{\url{https://github.com/takehaya/bpf-ninja}}
...
and \texttt{all()} applies the same element-wise rule. The walk requires a field giving the
