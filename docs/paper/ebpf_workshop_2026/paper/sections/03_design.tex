...
\texttt{any(E)} holds when some element of the list satisfies the
whole inner condition \texttt{E}, and \texttt{all(E)} holds when
every element does, where \texttt{E} may combine comparisons with
